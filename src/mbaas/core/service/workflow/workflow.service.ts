...
export class WorkflowService {
	...
	getRoute(stepID: string): string {
		const routes = {};
		routes[MBAAS_STEPS.BYC0010.STEP] = {route: `${MBAAS_ROUTING.PROYECTO}/${MBAAS_STEPS.BYC0010.ROUTE}`, routeId: MBAAS_STEPS.BYC0010.ROUTE_ID};
	...
	makeRequest(keyCatalogo: any) {
		const filterCatalogo = {
			modulo: this.obserStr.lastValue(MODULO) === null ? 'ROTATIVO' : this.obserStr.lastValue(MODULO),
